            ...
            try
            {
                ...
                ilCursor.EmitDelegate<Action<UIWorldCreation>>((self) =>
                {
                    ...
                    if (worldManageSystem.genMode > 0)
                    {
                        ...
                        mod.MetaData.BiomesChance = worldManageSystem.BiomesChance;
                        mod.MetaData.HardmodeChance = worldManageSystem.HardmodeChance;
                        mod.MetaData.StructureChance = worldManageSystem.StructureChance;
                        worldManageSystem.resetChance();
                        Console.WriteLine(mod.MetaData.BiomesChance["Forest"]);
                        if (worldManageSystem.genMode == GenMode.Special)
                        {
